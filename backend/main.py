...
def app_home():
 ...
 html=html.replace('<section id="travel"',message_section+cooking_section+disposal_section+phone_section+'<section id="travel"',1)
 extra_js="""
let messageTone='따뜻하고 자연스럽게';let cookingPreference='쉽고 간단하게';let phoneType='모르겠어요';let lastPhoneAnswer='';
